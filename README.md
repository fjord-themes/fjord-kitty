...
A dusk-blue base with primary leaf-green accents, cyan selections, and crisp blue/cyan separation for the Kitty terminal emulator.
...
For theme suggestions or issues, please open an issue on the [Kitty theme repository](https://github.com/fjord-themes/fjord-kitty/issues).